...
This Cookie Policy explains how **Imakita Industry** ("we," "us," and "our") uses cookies and similar technologies to recognize you when you visit our website at [https://docs.try-try.com](https://docs.try-try.com) and all its subdomains ("Website"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
