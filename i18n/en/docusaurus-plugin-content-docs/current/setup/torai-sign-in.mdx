...
![Torai sign-in](/img/english-manual/torai-sign-in/sign-in-en.png)
...
![Profile > API Keys](/img/english-manual/torai-sign-in/api-keys-en.png)
...
![API Keys page](/img/english-manual/torai-sign-in/api-keys-en.png)
...
![Enter the web app URL](/img/english-manual/torai-sign-in/api-keys-en.png)
...
![Generate verification code in the spreadsheet](/img/english-manual/torai-sign-in/g-sheet-torai-link.jpeg)

Copy the displayed verification code. It is valid for ten minutes.

![Displayed verification code](/img/english-manual/torai-sign-in/g-sheet-torai-verification-code.jpeg)
...
![Paste verification code](/img/english-manual/torai-sign-in/torai-enter-gas-url.jpeg)
...
![Enter Gemini API key](/img/english-manual/torai-sign-in/gemini_api_key.png)
...
![Enable Discord notifications and enter a Webhook URL](/img/getting-start/discord/06-torai-discord-setting-en.png)
