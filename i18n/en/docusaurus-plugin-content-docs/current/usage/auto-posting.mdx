...
![Trigger page](/img/english-manual/auto-posting/trigger-stopped-en.png)
...
![Select a trigger interval](/img/english-manual/auto-posting/trigger-interval-en.png)
...
![Trigger on](/img/english-manual/auto-posting/trigger-running-en.png)
...
![Published data](/img/english-manual/auto-posting/activity-posted.png)

If you configured Discord notifications, you receive a success or error message.

![Automated post result in Discord](/img/english-manual/auto-posting/discord_notify.png)

## 6. Check errors

If publishing fails, check the error list or logs.

![Torai post errors](/img/english-manual/auto-posting/activity-errors.png)
...
![Running trigger](/img/english-manual/auto-posting/trigger-running-en.png)

Confirm that the page shows **Automated posting: Stopped**.

![Stopped trigger](/img/english-manual/auto-posting/trigger-stopped-en.png)
