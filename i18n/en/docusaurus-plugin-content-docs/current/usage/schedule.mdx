...
![Trigger settings](/img/english-manual/auto-posting/trigger-stopped-en.png)

## 1. Open the post list

Select the destination X account and open its post list.

![Scheduled posts with post content redacted](/img/english-manual/schedule/scheduled-posts-en.png)
...
![Set publication date and time](/img/english-manual/x-posts/set-post-schedule.png)

After saving, the scheduled date and time appear in the post list.

![Scheduled time displayed](/img/english-manual/x-posts/post-type-en.png)
...
![Post list with scheduled times and post content redacted](/img/english-manual/schedule/scheduled-posts-en.png)

## 6. Start the trigger

After scheduling, open **Activity > Trigger Management** and start the trigger.

![Trigger interval](/img/english-manual/auto-posting/trigger-interval-en.png)

Be sure to switch the trigger to **Running**. It turns off automatically when there are no more scheduled posts.

![Start trigger](/img/english-manual/auto-posting/trigger-running-en.png)
